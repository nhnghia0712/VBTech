...
HD_PWD='D:/GitHub/VBTech/VBTech/BISTEthernetPacket/BISTEthernetPacket.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_ip.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_ip.tcl
