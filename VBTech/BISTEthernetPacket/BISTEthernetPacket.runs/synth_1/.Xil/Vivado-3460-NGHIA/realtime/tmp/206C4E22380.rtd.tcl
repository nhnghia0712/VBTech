...
set genomeRtd $env(RT_TMP)/206C4E22380.rtd
set parallel_map_command "rt::do_reinfer_area_combined 1"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {transmitter__GCB73}]"
...
set genomeName [subst -nocommands -novariables {transmitter__GCB73}]
