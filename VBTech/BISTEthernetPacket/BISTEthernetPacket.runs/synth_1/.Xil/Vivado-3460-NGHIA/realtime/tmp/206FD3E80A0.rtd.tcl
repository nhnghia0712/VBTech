...
set genomeRtd $env(RT_TMP)/206FD3E80A0.rtd
set parallel_map_command "rt::do_reinfer_area_combined 1"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {case__58_transmitter__GD}]"
...
set genomeName [subst -nocommands -novariables {case__58_transmitter__GD}]
