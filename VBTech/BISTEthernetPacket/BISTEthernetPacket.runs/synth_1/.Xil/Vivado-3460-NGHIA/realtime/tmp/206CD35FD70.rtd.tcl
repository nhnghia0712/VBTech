...
set genomeRtd $env(RT_TMP)/206CD35FD70.rtd
set parallel_map_command "rt::do_reinfer_area_combined 1"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {case__84_transmitter__GD}]"
...
set genomeName [subst -nocommands -novariables {case__84_transmitter__GD}]
