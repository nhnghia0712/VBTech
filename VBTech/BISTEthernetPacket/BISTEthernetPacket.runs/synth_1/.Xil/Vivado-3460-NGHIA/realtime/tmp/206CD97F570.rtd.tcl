...
set genomeRtd $env(RT_TMP)/206CD97F570.rtd
set parallel_map_command "rt::do_reinfer_area_combined 1"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {muxpart__13_transmitter}]"
...
set genomeName [subst -nocommands -novariables {muxpart__13_transmitter}]
