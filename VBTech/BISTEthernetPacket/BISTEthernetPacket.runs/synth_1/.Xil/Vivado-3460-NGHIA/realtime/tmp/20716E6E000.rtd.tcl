...
set genomeRtd $env(RT_TMP)/20716E6E000.rtd
set parallel_map_command "rt::do_reinfer_area_combined 1"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {transmitter__GCB3}]"
...
set genomeName [subst -nocommands -novariables {transmitter__GCB3}]
