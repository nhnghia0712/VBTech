...
set genomeRtd $env(RT_TMP)/1D50751B470.rtd
set parallel_map_command "rt::do_techmap_steps"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {reg__21_transmitter}]"
...
set genomeName [subst -nocommands -novariables {reg__21_transmitter}]
