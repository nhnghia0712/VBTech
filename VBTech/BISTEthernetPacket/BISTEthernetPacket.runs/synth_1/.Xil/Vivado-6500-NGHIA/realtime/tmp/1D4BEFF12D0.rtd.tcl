...
set genomeRtd $env(RT_TMP)/1D4BEFF12D0.rtd
set parallel_map_command "rt::do_reinfer_area_combined 1"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {transmitter__GCB13}]"
...
set genomeName [subst -nocommands -novariables {transmitter__GCB13}]
