...
set genomeRtd $env(RT_TMP)/1D4D283E270.rtd
set parallel_map_command "rt::do_techmap_steps"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {case__4682_receiver__GD}]"
...
set genomeName [subst -nocommands -novariables {case__4682_receiver__GD}]
