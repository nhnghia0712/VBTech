...
set genomeRtd $env(RT_TMP)/1D51049E6D0.rtd
set parallel_map_command "rt::do_techmap_steps"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {transmitter__GCB15}]"
...
set genomeName [subst -nocommands -novariables {transmitter__GCB15}]
