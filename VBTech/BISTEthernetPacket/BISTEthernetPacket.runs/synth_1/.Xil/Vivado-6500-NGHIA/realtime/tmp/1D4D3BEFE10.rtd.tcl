...
set genomeRtd $env(RT_TMP)/1D4D3BEFE10.rtd
set parallel_map_command "rt::do_techmap_steps"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {datapath__7_transmitter__GD}]"
...
set genomeName [subst -nocommands -novariables {datapath__7_transmitter__GD}]
