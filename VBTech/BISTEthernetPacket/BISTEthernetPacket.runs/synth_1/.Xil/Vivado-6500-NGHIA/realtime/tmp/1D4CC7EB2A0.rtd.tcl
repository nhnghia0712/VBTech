...
set genomeRtd $env(RT_TMP)/1D4CC7EB2A0.rtd
set parallel_map_command "rt::do_techmap_steps"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {transmitter__GCB16}]"
...
set genomeName [subst -nocommands -novariables {transmitter__GCB16}]
