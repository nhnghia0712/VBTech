...
set genomeRtd $env(RT_TMP)/1D4D283FA30.rtd
set parallel_map_command "rt::do_techmap_steps"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {fsm__1__GB2}]"
...
set genomeName [subst -nocommands -novariables {fsm__1__GB2}]
