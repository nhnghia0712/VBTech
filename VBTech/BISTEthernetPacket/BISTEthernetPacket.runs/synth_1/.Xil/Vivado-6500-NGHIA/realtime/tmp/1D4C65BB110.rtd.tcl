...
set genomeRtd $env(RT_TMP)/1D4C65BB110.rtd
set parallel_map_command "rt::do_reinfer_area_combined 1"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {transmitter__GCB14}]"
...
set genomeName [subst -nocommands -novariables {transmitter__GCB14}]
