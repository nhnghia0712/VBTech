...
set genomeRtd $env(RT_TMP)/1D502E4ED00.rtd
set parallel_map_command "rt::do_techmap_steps"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {receiver__GCB15}]"
...
set genomeName [subst -nocommands -novariables {receiver__GCB15}]
