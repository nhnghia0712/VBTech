...
set genomeRtd $env(RT_TMP)/1D4CCC01D50.rtd
set parallel_map_command "rt::do_techmap_steps"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {datapath__29_receiver__GD}]"
...
set genomeName [subst -nocommands -novariables {datapath__29_receiver__GD}]
