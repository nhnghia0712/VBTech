...
set genomeRtd $env(RT_TMP)/1D4B7DAC490.rtd
set parallel_map_command "rt::do_techmap_steps"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {receiver__GCB7}]"
...
set genomeName [subst -nocommands -novariables {receiver__GCB7}]
